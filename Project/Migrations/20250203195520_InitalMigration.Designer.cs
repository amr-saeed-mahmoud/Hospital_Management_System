...
namespace Project.Migrations
{
    ...
    [Migration("20250203195520_InitalMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Domain.Services.MedicalRecord", b =>
                {
                    b.HasOne("Models.Domain.Services.MedicalRecord", "CurrentAppointment")
                        .WithMany()
            ...
            modelBuilder.Entity("Models.Domain.Services.Payment", b =>
                {
                    b.HasOne("Models.Domain.Services.Payment", "CurrentAppointment")
                        .WithMany()
                        .HasForeignKey("AppointmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
